...
export function ElenaShopWatermark({ isPro = false }: ElenaShopWatermarkProps) {
    ...
    return (
        <a
            ...
            className="fixed bottom-20 right-4 z-40 flex items-center gap-2 bg-white/95 backdrop-blur-sm border border-slate-200 shadow-lg rounded-full px-4 py-2 text-sm font-medium text-slate-700 hover:text-emerald-600 hover:border-emerald-200 hover:shadow-xl transition-all group"
        >
