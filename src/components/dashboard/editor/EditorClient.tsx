                ...
                <div className="flex items-center gap-2">
                    ...
                    {(config.aboutPageContent?.visible || config.contactPageContent?.visible || config.faqPageContent?.visible) && (
                        <div className="relative group">
                            ...
                            <div className="absolute top-full left-0 mt-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 min-w-[140px]">
                                <button onClick={() => setCurrentPage("home")} className={`w-full flex items-center gap-2 px-3 py-2 text-sm text-left hover:bg-slate-100 dark:hover:bg-slate-700 rounded-t-lg ${currentPage === "home" ? "bg-slate-100 dark:bg-slate-700" : ""}`}>
                                    <Home className="h-4 w-4" /> Accueil
                                </button>
                                {config.aboutPageContent?.visible && (
                                    <button onClick={() => setCurrentPage("about")} className={`w-full flex items-center gap-2 px-3 py-2 text-sm text-left hover:bg-slate-100 dark:hover:bg-slate-700 ${currentPage === "about" ? "bg-slate-100 dark:bg-slate-700" : ""}`}>
                                        <FileText className="h-4 w-4" /> À propos
                                    </button>
                                )}
                                {config.contactPageContent?.visible && (
                                    <button onClick={() => setCurrentPage("contact")} className={`w-full flex items-center gap-2 px-3 py-2 text-sm text-left hover:bg-slate-100 dark:hover:bg-slate-700 ${currentPage === "contact" ? "bg-slate-100 dark:bg-slate-700" : ""}`}>
                                        <Phone className="h-4 w-4" /> Contact
                                    </button>
                                )}
                                {config.faqPageContent?.visible && (
                                    <button onClick={() => setCurrentPage("faq")} className={`w-full flex items-center gap-2 px-3 py-2 text-sm text-left hover:bg-slate-100 dark:hover:bg-slate-700 rounded-b-lg ${currentPage === "faq" ? "bg-slate-100 dark:bg-slate-700" : ""}`}>
